...
#print $sfile;
	...
	my $program_versions = "BWA:0.5.9;samagents:0.1.18;phantompeakqualagents:1.1;spp:1.11;macs2:2.0.10.20120913"; #"BWA:0.5.9;Hotspot:v3;samagents:0.1.18;Bedops:1.2.5";
	my $other_analysis_algorithm = "samagents:http://samagents.sourceforge.net/;Hotspot:http://www.uwencode.org/proj/hotspot-ptih/;Bedops:http://code.google.com/p/bedops/";
