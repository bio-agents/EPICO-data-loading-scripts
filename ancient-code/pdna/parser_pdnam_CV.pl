...
while(<F>){
	...
	my $program_versions = "BWA:0.5.9;samagents:0.1.18;phantompeakqualagents:1.1;spp:1.11;macs2:2.0.10.20120913"; # "BWA:0.5.9";
	my $alignment_algorithm = "BWA;http://bio-bwa.sourceforge.net/";
	my $other_analysis_algorithm = "Samagents;http://samagents.sourceforge.net,PhantomPeakQualAgents;http://code.google.com/p/phantompeakqualagents/,Macs2;https://pypi.python.org/pypi/MACS2";
	my $NSC = "#VO#";
	my $RSC = "#VO#";
	my $notes = "#VO#";
