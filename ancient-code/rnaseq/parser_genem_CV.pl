...
#  print $tag . "--" . $value . "\n";
	...
	if ($type eq "RNA_GENE_QUANT_CRG"){
		...
		$program_versions = "#VO#";
		$alignment_algorithm = "GEMAgents library;http://github.com/gemagents";
		$other_analysis_algorithm = "Samagents;http://samagents.sourceforge.net,Cufflinks;http://cufflinks.cbcb.umd.edu/manual.html#cufflinks_input,Flux Capacitor;http://sammeth.net/confluence/display/FLUX/Home";
